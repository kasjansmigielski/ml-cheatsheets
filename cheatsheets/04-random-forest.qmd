...
```{python}
#| echo: false
#| fig-cap: "Ważność cech w Random Forest"
#| fig-width: 10
#| fig-height: 6
...
## ⚙️ Tuning parametrów Random Forest
...
1. **Finanse:** Credit scoring, wykrywanie prania pieniędzy, trading algorytmiczny
2. **E-commerce:** Systemy rekomendacji, dynamic pricing, churn prediction
3. **Healthcare:** Diagnoza medyczna, drug discovery, analiza obrazów medycznych
...
**Następna ściągawka:** [K-Means Clustering - grupowanie bez etykiet](05-kmeans.qmd)! 🎯
